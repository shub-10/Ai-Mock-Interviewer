...
export const InterviewRoom = () => {
  ...
  const { selectedRole, selectedRound, difficultyLevel } = useInterview()
  ...
  useEffect(() => {
    ...
    const startInterview = async () => {
      const systemMsg = { role: "Interviewer", content: `You are interviewing a candidate for ${selectedRole}.This is going to be ${selectedRound} round with ${difficultyLevel} level. Ask the first question` }
      ...
      setContext(prev=>[...prev, { role: 'Assitant', content: data.question }])
      setLoading(false);
    }
    startInterview();
  }, [])
